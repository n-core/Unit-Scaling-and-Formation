...
--  Civillian & Special Units
    ...
    --  SETTLING UNITS
        ...
        --  COLONIST
            ...
            --SUG
            --(   'ART_DEF_UNIT_COLONIST',                    'ART_DEF_UNIT_MEMBER_COLONIST2',                    'SUG',  'LAND', 'VP',   0.205,  1,          ''),
            (   'ART_DEF_UNIT_COLONIST',                    'ART_DEF_UNIT_MEMBER_COLONIST3',                    'SUG',  'LAND', 'VP',   0.173,  1,          ''),
            --(   'ART_DEF_UNIT_COLONIST',                    'ART_DEF_UNIT_MEMBER_COLONIST4',                    'SUG',  'LAND', 'VP',   0.173,  1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  DIPLOMACY UNITS
        ------- UnitInfo ---------------------------------- UnitMemberInfo ------------------------------------ Type -- Domain  ModMod  Scale - NumMembers  Formation -----------
...
--  Military Units
    ...
    --  INDUSTRIAL ERA
        ...
        --  FIELD GUN
            ...
            (   'ART_DEF_UNIT_FIELD_GUN',                   'ART_DEF_UNIT_MEMBER_FIELD_GUN',                    'SUG',  'LAND', 'VP',   0.245,  1,          ''),
        --	CRUISER
    ...
    --  MODERN ERA
        ...
        --  LIGHT TANK (ARMORED_CAR) [formerly ANTI_TANK_GUN]
            ...
            (   'ART_DEF_UNIT_ARMORED_CAR',                 'ART_DEF_UNIT_MEMBER_ARMORED_CAR',                  'SUG',  'LAND', 'VP',   0.27,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  ATOMIC ERA
        ------- UnitInfo ---------------------------------- UnitMemberInfo ------------------------------------ Type -- Domain  ModMod  Scale - NumMembers  Formation -----------
        --  MERCENARIES
