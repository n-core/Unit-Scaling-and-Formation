...
--  Base Civilizations
    ...
    --  BARBARIAN
        ...
        --  BARBARIAN GALLEY
            ...
            (   'ART_DEF_UNIT_BARBARIAN_GALLEY',                    'ART_DEF_UNIT_MEMBER_BARBARIAN_GALLEY',                     'SUG',  'SEA',  0.143,  1,          ''),
        --  BARBARIAN SPEARMAN
            --RED
    ...
    --  CARTHAGE
        ...
        --	AFRICAN FOREST ELEPHANT
            ...
            (   'ART_DEF_UNIT_U_CARTHAGE_AFRICANFOREST_ELEPHANT',   'ART_DEF_UNIT_MEMBER_U_CARTHAGE_AFRICANFOREST_ELEPHANT',    'SUG',  'LAND', 0.23,   1,          ''),
        --  QUINQUEREME
    ...
    --  INDIA
        ...
        --  WAR ELEPHANT
            ...
            (   'ART_DEF_UNIT_U_INDIAN_WARELEPHANT',                'ART_DEF_UNIT_MEMBER_U_INDIAN_WARELEPHANT',                 'SUG',  'LAND', 0.23,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  INDONESIA
        ------- UnitInfo ------------------------------------------ UnitMemberInfo -------------------------------------------- Type -- Domain  Scale - NumMembers  Formation ---
        --  KRIS SWORDSMAN
    ...
    --  SHOSHONE
        ...
        --	PATHFINDER
            ...
            (   'ART_DEF_UNIT_U_SHOSHONE_PATHFINDER',               'ART_DEF_UNIT_MEMBER_U_SHOSHONE_PATHFINDER',                'SUG',  'LAND', 0.25,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  SIAM
        ------- UnitInfo ------------------------------------------ UnitMemberInfo -------------------------------------------- Type -- Domain  Scale - NumMembers  Formation ---
        --  NASERUAN'S ELEPHANT
            ...
            (   'ART_DEF_UNIT_U_SIAMESE_WARELEPHANT',               'ART_DEF_UNIT_MEMBER_U_SIAMESE_WARELEPHANT',                'SUG',  'LAND', 0.23,   1,          ''),
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    --  SONGHAI
        ------- UnitInfo ------------------------------------------ UnitMemberInfo -------------------------------------------- Type -- Domain  Scale - NumMembers  Formation ---
        --  MANDEKALU CAVALRY
