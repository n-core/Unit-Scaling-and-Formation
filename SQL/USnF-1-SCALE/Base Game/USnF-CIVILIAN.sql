...
--  Civilian & Special Units
    ...
    --  TRADE UNITS
        ...
        --  CARAVAN (LATE)
            ...
            --SUG
            (   'ART_DEF_UNIT_CARAVAN_MODERN',              'ART_DEF_UNIT_MEMBER_CARAVAN_LATE',                 'SUG',  'LAND', 0.173,  1,          ''),
            --(   'ART_DEF_UNIT_CARAVAN_MODERN',              'ART_DEF_UNIT_MEMBER_CARAVAN_LATE_F1',              'SUG',  'LAND', 0.173,  1,          ''),
            --(   'ART_DEF_UNIT_CARAVAN_MODERN',              'ART_DEF_UNIT_MEMBER_CARAVAN_LATE_F2',              'SUG',  'LAND', 0.173,  1,          ''),
        --  CARGO SHIP (EARLY)
    ...
    --  GREAT PERSON UNITS
        ...
        --	GREAT ENGINEER (LATE)
            ...
            (   'ART_DEF_UNIT_ENGINEER_LATE',               'ART_DEF_UNIT_MEMBER_GREATENGINEER_LATE',           'SUG',  'LAND', 0.218,  1,          ''),
        ...
        --	GREAT MERCHANT (LATE)
            ...
            (   'ART_DEF_UNIT_MERCHANT_LATE',               'ART_DEF_UNIT_MEMBER_GREATMERCHANT_LATE',           'SUG',  'LAND', 0.205,  1,          ''),
        ...
        --	GREAT GENERAL (EARLY)
            ...
            (   'ART_DEF_UNIT_GENERAL',                     'ART_DEF_UNIT_MEMBER_GREATGENERAL_EARLY',           'SUG',  'LAND', 0.24,   1,          ''),
        --	GREAT GENERAL (MODERN)
            ...
            (   'ART_DEF_UNIT_GENERAL_MODERN',              'ART_DEF_UNIT_MEMBER_GREATGENERAL_LATE',            'SUG',  'LAND', 0.24,   1,          ''),
        --	GREAT ADMIRAL (EARLY)
        ...
        --	GREAT ADMIRAL (MODERN)
            ...
            (   'ART_DEF_UNIT_GREAT_ADMIRAL_MODERN',        'ART_DEF_UNIT_MEMBER_GREAT_ADMIRAL_LATE',           'SUG',  'SEA',  0.23,   1,          ''),
        --	GREAT PROPHET
            --RED
